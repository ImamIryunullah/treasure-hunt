<template>
    <div class="min-h-screen bg-gradient-to-br from-red-500 via-red-600 to-red-700 flex items-center justify-center p-4">
      ...
      <div class="relative bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-100">
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-2xl font-bold text-gray-800 mb-2">Treasure Hunt</h1>
          <p class="text-sm text-gray-600">UNTAG Surabaya</p>
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <button
            type="submit"
            :disabled="isLoading"
            class="w-full bg-red-500 hover:bg-red-600 disabled:bg-red-300 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center"
          >
            <svg
              v-if="isLoading"
        ...
        <div class="mt-8 pt-6 border-t border-gray-200">
          <p class="text-center text-sm text-gray-600">
            Belum memiliki akun?
            <a href="#" class="text-red-500 hover:text-red-600 font-medium ml-1">
              Daftar sekarang
            </a>
          </p>
        </div>
        ...
        <div class="mt-6 text-center">
          <p class="text-xs text-gray-500">
            © 2025 UNTAG Surabaya. All rights reserved.
          </p>
        </div>
      </div>
      ...
      <div class="absolute top-1/3 right-20 w-12 h-12 bg-white bg-opacity-10 rounded-full animate-pulse" style="animation-delay: 2s;"></div>
    </div>
  </template>
      ...
      const handleLogin = async () => {
        try {
          ...
          if (loginForm.nim === "admin" && loginForm.password === "password") {
            ...
            window.location.href = "/dashboard"; // Atau gunakan router push jika pakai Vue Router
          } else {
